...
+ (NSError *)deflateErrorWithCode:(int)code
{
	...
	return [NSError errorWithDomain:NetworkRequestErrorDomain code:ASICompressionError userInfo:[NSDictionary dictionaryWithObjectsAndKeys:[NSString stringWithFormat:@"Compression of data failed with code %hi",lsCode],NSLocalizedDescriptionKey,nil]];
}
